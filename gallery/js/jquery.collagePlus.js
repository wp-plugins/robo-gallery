...
(function( window, $, undefined ){
    ...
    var CollagePlus = function(container, options){
     ...
     * ====================================================================== */
        ...
        /* VARS */ 
        var $container                  = $(container).addClass('rbs-imges-container');        
        var itemSelector                = '.rbs-img';
        var boxImageSelector            = '.rbs-img-image';
        var itemClass                   = 'rbs-img'; /* same as itemSelector but without the '.' */
        var itemHiddenClass             = 'rbs-img-hidden';
        ...
        /* LOAD MORE BUTTON */
        var loadMoreButton              = $('<div class="rbs-imges-load-more button"></div>').insertAfter($container);
        loadMoreButton.wrap('<div class="rbs_gallery_button  rbs_gallery_button_bottom"></div>');
        loadMoreButton.addClass(settings.loadMoreClass);
        ...
        $container.append('<div class="rbs-imges-grid-sizer"></div>');
        ...
        $container.eveMB({
            ...
            masonry: {
                columnWidth: '.rbs-imges-grid-sizer'
            },
     ...
     * ====================================================================== */
        ...
        function addPopupTrigger(container){
            ...
            container.find(itemSelector+', .'+itemHiddenClass).find(boxImageSelector+':not([data-popupTrigger])').each(function(){
                ...
                var popupTrigger = boxImage.find('.rbs-lightbox').addBack('.rbs-lightbox');
        ...
        function convertDivsIntoImages(container, imagesWithDimensions){
            container.find(itemSelector).find(boxImageSelector+':not([data-imageconverted])').each(function(){
                ...
                thumbnailDiv.addClass('rbs-img-thumbnail-container').prepend(imgHTML);
            });
        ...
        function setDimensionsToImageContainer(container){
            container.find(itemSelector).each(function(){
                ...
                //console.log( thumbnailDiv.width() + ":" + box.css("bborder-left-width") );
                var borderFix = container.data('settings').borderSize * 2;
                boxImage.width( thumbnailDiv.width() - borderFix );
                boxImage.height( thumbnailDiv.height() - borderFix );
        ...
        function setColumnWidth(container, columnWidth, columns){
            var collagePlus = container.find(itemSelector);
            var newWidth;
            ...
            container.find('.rbs-imges-grid-sizer').css( 'width' , newWidth );
            
            collagePlus.each(function(index){
                var $this       = $(this);
        ...
        function addWrapperForMargins(container){
            //alert(container.data('settings').horizontalSpaceBetweenBoxes);
            var wrapper = $('<div class="rbs-img-container"></div')
                            .css({
            ...
            boxes.each(function(){
                ...
                if(boxImage.data('overlay-effect') != undefined){
                    ...
                    if( effect == 'push-up' || effect == 'push-down' || effect == 'push-up-100%' || effect == 'push-down-100%'  ){
                            ...
                            var thumbnailDiv        = boxImage.find('.rbs-img-thumbnail-container');
        ...
        function hideOverlaysOnResize(container){
            ...
            container.eveMB('layout');
        }



        $.extend( EveMB.prototype, {
            resize : function() {
            ...
            insert : function( elems, callback ) {
                ...
                container.find('img:not([data-dont-wait-for-me])').imagesLoadedMB()
                    .always(function(){
                        ...
                        container.find(itemSelector).addClass('rbs-img-loaded');
        ...
        function updateFilterClasses(){
            ...
            boxes.filter( filter ).removeClass('hidden-rbs-imges-by-filter').addClass('visible-rbs-imges-by-filter');
            boxes.not( filter ).addClass('hidden-rbs-imges-by-filter').removeClass('visible-rbs-imges-by-filter');
        }
        ...
        function goAndFilterIsotope(filterValue, filterGroup){
            ...
            $container.eveMB({ filter: combineFilters(filters) });
        }
     ...
     * ====================================================================== */
        ...
        function getLoadingBoxesInCurrentFilter(){
            var boxes = getBoxesInCurrentFilter().not('.rbs-img-loaded');   

            return boxes;
        }

        function getCurrentFilter(){
            var filter = $container.data('eveMB').options.filter;
        ...
        function loading(){
            ...
            loadMoreButton.removeClass('rbs-imges-load-more');
            loadMoreButton.addClass('rbs-imges-loading');
        }
        ...
        function fixLoadMoreButton(){
            loadMoreButton.removeClass('rbs-imges-load-more');
            loadMoreButton.removeClass('rbs-imges-loading');
            loadMoreButton.removeClass('rbs-imges-no-more-entries');

            if( hiddenBoxesWaitingToLoad().length > 0 ){
                loadMoreButton.html(settings.loadMoreWord);
                loadMoreButton.addClass('rbs-imges-load-more'); 
            }else{
                loadMoreButton.html(settings.noMoreEntriesWord); 
                loadMoreButton.addClass('rbs-imges-no-more-entries');
            }
        }

        function loadMore( boxesToLoad, ignoreFilter){
            if( loadMoreButton.hasClass('rbs-imges-no-more-entries') == true ){ /* Only if it is the "load more" button or the "loading...", no the "no more entries" button */
                return;
            }
            ...
            $container.eveMB( 'insert', $(newBoxes), function(){
                /* Fix Load More Button */   
                finishLoading();
     ...
     * ====================================================================== */   
        ...
        filterContainer.find(settings.filter).on('click', function(e){
            ...
            filterContainer.find(settings.filter).removeClass(settings.filterContainerSelectClass);
            
            /* Add class of selected */
            $this.addClass(settings.filterContainerSelectClass);
            ...
            e.preventDefault();
            if( !loadMoreButton.is('.rbs-imges-no-more-entries') ){
     ...
     * ====================================================================== */     
        ...
        $(settings.sortContainer).find(settings.sort).on('click', function(e){
            ...
            $container.eveMB({ sortBy: sortValue, sortAscending: getSortDirection($this) });
     ...
     * ====================================================================== */
        ...
        var delegate = '.rbs-lightbox[data-mfp-src]';
        
        if(settings.considerFilteringInPopup){
            delegate = itemSelector+':not(.hidden-rbs-imges-by-filter) .rbs-lightbox[data-mfp-src], .'+itemHiddenClass+':not(.hidden-rbs-imges-by-filter) .rbs-lightbox[data-mfp-src]';
        }
        if(settings.showOnlyLoadedBoxesInPopup){
            delegate = itemSelector+':visible .rbs-lightbox[data-mfp-src]';
        }
                ...
                callbacks : {
                    change : function() {
                        ...
                        setTimeout(function(){ 
                            ...
                            var social = "<div class='rbs-imges-social-container'>";
                            if(settings.facebook != undefined){//FB
                              social+="<div class='rbs-imges-facebook fa fa-facebook-square' data-url='"+sharingURL+"'></div>";
                            }
                            if(settings.twitter != undefined){//Twitter
                              social+="<div class='rbs-imges-twitter fa fa-twitter-square' data-url='"+sharingURL+"'></div>";
                            }
                            if(settings.googleplus != undefined){//Google+
                              social+="<div class='rbs-imges-googleplus fa fa-google-plus-square' data-url='"+sharingURL+"'></div>";
                            }
                            if(settings.pinterest != undefined){//Pintrest
                              social+="<div class='rbs-imges-pinterest fa fa-pinterest-square' data-url='"+sharingURL+"'></div>";
                            }
                            social+="</div>";
                        ...
                        if(settings.deepLinking){
                            location.hash   = '#!' + item.attr('data-mfp-src') + '||' + item.parents('.rbs-imges-container').attr('id'); /* with the "src" of the image and the "id" of the container */
                        }
                    },
                    beforeOpen: function() {
     ...
     * ====================================================================== */
        ...
        if(settings.deepLinking){
                ...
                if (hashUrl) {
                    $container.filter('[id="' + hashUrl.id + '"]').find('.rbs-lightbox[data-mfp-src="' + hashUrl.src + '"]').trigger('click');
                }
                ...
                function doHash() {
                    ...
                    if (!url && mp.isOpen) {
                        ...
                        if ( mp.isOpen && mp.currItem && mp.currItem.el.parents('.rbs-imges-container').attr('id') == url.id ) {
                            ...
                            $container.filter('[id="' + url.id + '"]').find('.rbs-lightbox[data-mfp-src="' + url.src + '"]').trigger('click');
                        }
                    }
                }
     ...
     * ====================================================================== */
        ...
        //FACEBOOK SHARE
        $('body').on('click', 'div.rbs-imges-facebook', function(){
            var $this = $(this);
        ...
        //TWITTER SHARE
        $('body').on('click', 'div.rbs-imges-twitter', function(){
            var $this = $(this);
            var url = encodeURIComponent($this.data('url'));
        ...
        //GOOGLE PLUS
        $('body').on('click', 'div.rbs-imges-googleplus', function(){
            var $this = $(this);
            var url = encodeURIComponent($this.data('url'));
        ...
        //PINTREST
        $('body').on('click', 'div.rbs-imges-pinterest', function(){
            var $this = $(this);
            var url = encodeURIComponent($this.data('url'));
     ...
     $.fn.collagePlus = function(options) {
        ...
        return this.each(function(key, value){
            ...
            if (element.data('collagePlus')) return element.data('collagePlus');
            // Pass options to plugin constructor
            var collagePlus = new CollagePlus(this, options);
            // Store plugin object in this element's data
            element.data('collagePlus', collagePlus);

             $('.thumbnail-overlay a', this).click(function(event) {
    ...
    $.fn.collagePlus.defaults = {
        ...
        filterContainerSelectClass: 'active',
        filter: 'a',
        search: '', // i.e. #search
        searchTarget: '.rbs-img-title',
    ...
    (function(){
        ...
        function start($wrapper){
            var $menu           = $wrapper.find('.rbs-imges-drop-down-menu');
            var $header         = $wrapper.find('.rbs-imges-drop-down-header');
        ...
        $('.rbs-imges-drop-down').each(function(){
            start($(this));
        });
